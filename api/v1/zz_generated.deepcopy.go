...
func (in *AuditSpec) DeepCopyInto(out *AuditSpec) {
	*out = *in
	if in.RetentionsPeriod != nil {
		in, out := &in.RetentionsPeriod, &out.RetentionsPeriod
		*out = new(int)
		**out = **in
	}
	if in.Selector != nil {
	...
	if in.ReportingComponents != nil {
		in, out := &in.ReportingComponents, &out.ReportingComponents
		*out = make([]reportingComponents, len(*in))
		copy(*out, *in)
	}
	if in.Chunks != nil {
